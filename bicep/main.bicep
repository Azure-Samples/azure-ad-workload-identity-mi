...
param cosmosDbAccountName string = toLower('${aksClusterName}account')
...
param applicationInsightsName string = '${aksClusterName}ApplicationInsights'
...
module aksManageIdentity 'aksManagedIdentity.bicep' = {
  ...
  params: {
    ...
    workloadManagedIdentityName: '${aksClusterName}WorkloadIdentity'
...
module workloadManageIdentity 'workloadManagedIdentity.bicep' = {
  name: 'workloadManageIdentity'
  params: {
    managedIdentityName: '${aksClusterName}WorkloadIdentity'
    cosmosDbAccountName: cosmosDb.outputs.accountName
    serviceBusNamespaceName: serviceBus.outputs.namespaceName
    blobStorageAccountName: storageAccount.outputs.name
    keyVaultName: keyVault.outputs.name
  }
  dependsOn: [
    aksCluster
