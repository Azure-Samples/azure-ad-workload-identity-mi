// Parameters
@description('Specifies the name of the user-defined managed identity used by the AKS cluster.')
...
resource workloadManagedIdentity 'Microsoft.ManagedIdentity/userAssignedIdentities@2021-09-30-preview' = {
