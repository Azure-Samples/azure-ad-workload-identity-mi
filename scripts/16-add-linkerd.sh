...
kubectl get deployment $frontendDeployment -n $workloadNamespace -o yaml | linkerd inject - | kubectl apply -f -
kubectl get deployment $backendDeployment -n $workloadNamespace -o yaml | linkerd inject - | kubectl apply -f -